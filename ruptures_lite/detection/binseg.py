r"""Binary segmentation. Ported from ruptures (BSD-2-Clause)."""
...
from ruptures_lite.utils import pairwise, sanity_check
...
class Binseg(BaseEstimator):
    ...
    def _seg(self, n_bkps=None, pen=None, epsilon=None):
        """Compute the binary segmentation.
    ...
    def predict(self, n_bkps=None, pen=None, epsilon=None):
        ...
        Must be called after the fit method. The stopping rule depends on the
