r"""Dynamic programming. Ported from ruptures (BSD-2-Clause)."""
...
class Dynp(BaseEstimator):
    ...
    Given a segment model, computes the best partition for which the sum of
    errors is minimum.
    """

    def __init__(self, model="l2", custom_cost=None, min_size=2, jump=5, params=None):
        """Create a Dynp instance."""
    ...
    def seg(self, start, end, n_bkps):
        ...
        This method is memoized and then used.
