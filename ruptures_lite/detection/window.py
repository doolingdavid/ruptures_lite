r"""Window-based change point detection. Ported from ruptures (BSD-2-Clause)."""
...
from ruptures_lite.utils import unzip, sanity_check
    ...
    def fit(self, signal):
        ...
        for k in self.inds:
            ...
            if np.isinf(gain) and gain < 0:
                # segment is constant and no improvement possible on start .. end
                score.append(0)
                continue
