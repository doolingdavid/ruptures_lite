r"""Pelt. Ported from ruptures (BSD-2-Clause)."""
...
from ruptures_lite.base import BaseCost, BaseEstimator
from ruptures_lite.exceptions import BadSegmentationParameters
from ruptures_lite.utils import sanity_check
...
class Pelt(BaseEstimator):
    ...
    def __init__(self, model="l2", custom_cost=None, min_size=2, jump=5, params=None):
        ...
        Args:
            model (str, optional): segment model. Not used if ``custom_cost`` is set.
            custom_cost (BaseCost, optional): custom cost function.
            min_size (int, optional): minimum segment length.
            jump (int, optional): subsample (one every *jump* points).
            params (dict, optional): parameters for the cost instance.
        """
    ...
    def _seg(self, pen):
        """Compute the segmentation for a given penalty using PELT.
