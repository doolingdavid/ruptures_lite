r"""Bottom-up segmentation. Ported from ruptures (BSD-2-Clause)."""
...
from ruptures_lite.utils import Bnode, pairwise, sanity_check
    ...
    def _seg(self, n_bkps=None, pen=None, epsilon=None):
        ...
        while not stop:
            ...
            try:
                ...
                # Ignore merge candidates whose children no longer exist.
                while leaf.left in removed or leaf.right in removed:
                    gain, leaf = heapq.heappop(merged)
            except IndexError:  # if merged is empty
                break
