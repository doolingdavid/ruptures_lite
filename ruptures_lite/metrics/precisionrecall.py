r"""Precision and recall. Ported from ruptures (BSD-2-Clause)."""
...
def precision_recall(true_bkps, my_bkps, margin=10):
    """Precision/recall of an estimated segmentation vs the true segmentation.

    Args:
        true_bkps (list): last index of each regime (true partition).
        my_bkps (list): last index of each regime (computed partition).
